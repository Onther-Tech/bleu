...
import { Box, IconButton, Link, Table, TableBody, TableCell, TableRow, Typography } from '@mui/material';
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell>
                <Typography>
                  {timeSince(block.contents.batch_timestamp)} (
                  {new Date(+block.contents.batch_timestamp * 1000).toLocaleString()})
                </Typography>
              </TableCell>
            </TableRow>
            <TableRow>
              ...
              <TableCell>
                <Link underline="none" href={`/txs?blockNum=${block.contents.batch_index}&isState=${props.isState}`}>
                  {block.contents.batch_size}
                </Link>
              </TableCell>
            </TableRow>
            <TableRow>
