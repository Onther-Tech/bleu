    ...
    <TableRow>
      <TableCell>
        <Table size="small">
          <TableBody>
            <TableRow>
              <TableCell sx={{ border: 'none', textAlign: 'right' }}>Address</TableCell>
            ...
            {log.topics.map((row, index) => (
              <TableRow key={`topic-${index}`}>
                <TableCell sx={{ border: 'none', textAlign: 'right' }}>{index === 0 ? 'Topics' : ''}</TableCell>
                <TableCell sx={{ border: 'none' }}>{`[${index}] ${row}`}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
